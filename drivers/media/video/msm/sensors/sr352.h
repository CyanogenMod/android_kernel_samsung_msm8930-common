...
#define PREVIEW_SIZE_1024x576 11  /*1024x576*/
...
struct sr352_i2c_reg_conf {
	unsigned short waddr;
	unsigned short wdata;
};

enum sr352_test_mode_t {
	TEST_OFF,
	TEST_1,
	TEST_2,
	TEST_3
...
static struct sr352_ctrl *sr352_ctrl;
static struct i2c_client *sr352_client;
static struct sr352_exif_data *sr352_exif;
static struct msm_sensor_ctrl_t sr352_s_ctrl;
static struct device sr352_dev;
