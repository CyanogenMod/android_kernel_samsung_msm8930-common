...
#define PLATFORM_DRIVER_NAME "msm_camera_sr200pc20m"
#define sr200pc20m_obj sr200pc20m_##obj
...
struct sr200pc20m_work {
	struct work_struct work;
};

struct sr200pc20m_exif_data {
	unsigned short iso;
	unsigned short shutterspeed;
};

struct sr200pc20m_ctrl {
	const struct msm_camera_sensor_info *sensordata;
	struct sr200pc20m_userset settings;
...
struct sr200pc20m_i2c_reg_conf {
	unsigned short waddr;
	unsigned short wdata;
};

enum sr200pc20m_test_mode_t {
	TEST_OFF,
	TEST_1,
	TEST_2,
	TEST_3
...
enum sr200pc20m_resolution_t {
	QTR_SIZE,
	FULL_SIZE,
	INVALID_SIZE
};
enum sr200pc20m_setting {
	RES_PREVIEW,
	RES_CAPTURE
};
enum sr200pc20m_reg_update {
...
static struct sr200pc20m_ctrl *sr200pc20m_ctrl;
static struct i2c_client *sr200pc20m_client;
static struct sr200pc20m_exif_data *sr200pc20m_exif;
static struct msm_sensor_ctrl_t sr200pc20m_s_ctrl;
static struct device sr200pc20m_dev;
