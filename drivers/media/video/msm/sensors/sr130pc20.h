...
#define PLATFORM_DRIVER_NAME "msm_camera_sr130pc20"
#define sr130pc20_obj sr130pc20_##obj
...
#define SR130PC20_DELAY		0xFF00


struct sr130pc20_userset {
...
struct sr130pc20_work {
	struct work_struct work;
};

struct sr130pc20_exif_data {
	unsigned short iso;
	unsigned short shutterspeed;
};

struct sr130pc20_ctrl {
	const struct msm_camera_sensor_info *sensordata;
	struct sr130pc20_userset settings;
...
struct sr130pc20_i2c_reg_conf {
	unsigned short waddr;
	unsigned short wdata;
};

enum sr130pc20_test_mode_t {
	TEST_OFF,
	TEST_1,
	TEST_2,
	TEST_3
...
enum sr130pc20_resolution_t {
	QTR_SIZE,
	FULL_SIZE,
	INVALID_SIZE
};
enum sr130pc20_setting {
	RES_PREVIEW,
	RES_CAPTURE
};
enum sr130pc20_reg_update {
...
static struct sr130pc20_ctrl *sr130pc20_ctrl;
static struct i2c_client *sr130pc20_client;
static struct sr130pc20_exif_data *sr130pc20_exif;
static struct msm_sensor_ctrl_t sr130pc20_s_ctrl;
static struct device sr130pc20_dev;
