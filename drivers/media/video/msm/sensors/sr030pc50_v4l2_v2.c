...
#include "sr030pc50_regs_cane.h"
#elif defined(CONFIG_MACH_CANE_SKT) || defined(CONFIG_MACH_CANE_KTT)
...
#if (defined(CONFIG_ISX012) || defined(CONFIG_S5K4ECGX)) && defined(CONFIG_SR030PC50_V2)
