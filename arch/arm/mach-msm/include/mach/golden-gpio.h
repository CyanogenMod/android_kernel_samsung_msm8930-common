...
#else
#define GPIO_2MIC_I2C_SDA		0
#define GPIO_2MIC_I2C_SCL		0
#endif
...
#define GPIO_FUELGAUGE_I2C_SDA  101 /* 79 for rev00 */
#define GPIO_FUELGAUGE_I2C_SCL  100 /* 80 for rev00 */
