...
#if 0//fined(CONFIG_USB_SWITCH_TSU6721)
...
static struct gpiomux_setting lm48560_i2c[] = {
	/* Suspended state */
	{
		.func = GPIOMUX_FUNC_GPIO,
		.drv = GPIOMUX_DRV_2MA,
...
#if 0// CONFIG_USB_SWITCH_TSU6721
	{
...
#ifdef CONFIG_LM48560_RCV
static struct msm_gpiomux_config msm8960_lm486560_configs[] __initdata = {

	{
		.gpio = 51,
		.settings = {
			[GPIOMUX_SUSPENDED] = &lm48560_i2c[0],
			[GPIOMUX_ACTIVE] = &lm48560_i2c[1],
		},
	},
	{
		.gpio = 52,
...
#else
static struct msm_gpiomux_config sdc4_interface[] __initdata = {
	{
		.gpio = 83,
		.settings = {
...
static struct msm_gpiomux_config hall_ic_configs[] __initdata = {
	{
		.gpio      = 33,
		.settings = {
...
static struct gpiomux_setting gpio_si4705_suspend_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
    .dir = GPIOMUX_IN,
};
static struct msm_gpiomux_config si4705_configs[] __initdata = {
	{
		.gpio      = GPIO_FM_SDA_1_8V,
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_si4705_suspend_config,
		},
	},
	{
		.gpio      = GPIO_FM_SCL_1_8V,
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_si4705_suspend_config,
		},
	},	
...
#ifdef CONFIG_LM48560_RCV
	msm_gpiomux_install(msm8960_lm486560_configs,
			ARRAY_SIZE(msm8960_lm486560_configs));
#endif
...
#ifdef CONFIG_SENSORS_HALL
    msm_gpiomux_install(hall_ic_configs, ARRAY_SIZE(hall_ic_configs));
#endif
#ifdef CONFIG_FM_SI4705
	msm_gpiomux_install(si4705_configs, ARRAY_SIZE(si4705_configs));
#endif
	return 0;
}
