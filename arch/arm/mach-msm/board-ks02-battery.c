...
sec_battery_platform_data_t sec_battery_pdata = {
	...
	.bat_irq = IF_PMIC_IRQ_BASE + MAX77693_CHG_IRQ_BAT_I,
...
#if defined(CONFIG_MACH_KS02)
	/* temporarily */
	.temp_high_threshold_event = 614,
	.temp_high_recovery_event = 417,
	.temp_low_threshold_event = -63,
	.temp_low_recovery_event = -15,

	.temp_high_threshold_normal = 614,
	.temp_high_recovery_normal = 417,
	.temp_low_threshold_normal = -63,
	.temp_low_recovery_normal = -15,

	.temp_high_threshold_lpm = 614,
	.temp_high_recovery_lpm = 417,
	.temp_low_threshold_lpm = -63,
