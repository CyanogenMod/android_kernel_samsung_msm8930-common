...
static struct i2c_gpio_platform_data gpio_i2c_data_chg = {
	.sda_pin = GPIO_CHARGE_I2C_SDA,
	.scl_pin = GPIO_CHARGE_I2C_SCL,
};
...
static bool sec_fg_gpio_init(void)
{
	...
	gpio_tlmm_config(GPIO_CFG(gpio_i2c_data_fg.sda_pin,  0,
			GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), 1);
	gpio_set_value(gpio_i2c_data_fg.scl_pin, 1);
	gpio_set_value(gpio_i2c_data_fg.sda_pin, 1);
...
void __init msm8960_init_battery(void)
{
	...
	gpio_i2c_data_fg.sda_pin = GPIO_FUELGAUGE_I2C_SDA;
	gpio_i2c_data_fg.scl_pin = GPIO_FUELGAUGE_I2C_SCL;
