...
#if defined(CONFIG_TOUCHSCREEN_MMS136) || defined(CONFIG_TOUCHSCREEN_ZINITIX_BT432)
...
static struct platform_device *jasper2_devices[] __initdata = {
	&msm8960_device_otg,
...
void __init msm8930_jasper2_init(void)
{
#ifdef CONFIG_SEC_DEBUG
	sec_debug_init();
#endif
...
#endif
	platform_add_devices(jasper2_devices, ARRAY_SIZE(jasper2_devices));
#ifdef CONFIG_MSM_CAMERA
	msm8930_init_cam();
#endif
	msm8930_init_mmc();
